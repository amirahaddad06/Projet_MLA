...
# Nombre d'images dans Oxford-102
N_IMAGES = 8189
...
LIST_ATTR_PATH = "/home/ityt/Documents/Hicham/M2/MLA/Projet_MLA/Traitement_Data_Oxford/recup_attr_ox_brut/oxford102_attributs_final.txt"
ATTR_PATH = "/home/ityt/Documents/Hicham/M2/MLA/Projet_MLA/Traitement_Data_Oxford/Data_preprocessed/attributes_ox.pth"
...
def preprocess_attributes():
    ...
    # Ligne 1 : noms des 9 attributs Oxford-102
    attr_keys = attr_lines[1].split()
    assert len(attr_keys) == 9
    ...
    for i, line in enumerate(attr_lines[2:]):
        image_id = i + 1
        split = line.split()
        assert split[0] == ("image_%05i.jpg" % image_id)
        values = split[1:]
        assert len(values) == 9
